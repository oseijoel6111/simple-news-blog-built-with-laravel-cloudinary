        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <h2 class="heading text-center">Your most unhappy customers are your greatest source of learning.
                    </h2>
                    <p class="lead mb-4 text-center">Far far away, behind the word mountains, far from the countries
                        Vokalia and Consonantia, there live the blind texts.</p>
                    <img src="images/img_2.jpg" alt="Image" class="img-fluid rounded mb-4">
                    <p>
                    ...
                    <div class="row g-1 my-5">
                        <div class="col-lg-4">
                            <a href="images/post_lg_1.jpg" class="glightbox"><img src="images/post_lg_1.jpg" alt="Image"
                                    class="img-fluid rounded"></a>
                        </div>
                        <div class="col-lg-4">
                            <a href="images/post_lg_2.jpg" class="glightbox"><img src="images/post_lg_2.jpg" alt="Image"
                                    class="img-fluid rounded"></a>
                        </div>
                        <div class="col-lg-4">
                            <a href="images/post_lg_3.jpg" class="glightbox"><img src="images/post_lg_3.jpg" alt="Image"
                                    class="img-fluid rounded"></a>
                        </div>
                        <div class="col-lg-4">
                            <a href="images/post_lg_4.jpg" class="glightbox"><img src="images/post_lg_4.jpg" alt="Image"
                                    class="img-fluid rounded"></a>
                        </div>
                        <div class="col-lg-4">
                            <a href="images/post_lg_1.jpg" class="glightbox"><img src="images/post_lg_1.jpg" alt="Image"
                ...
                <div class="col-lg-12">
                    <div class="post-entry d-md-flex small-horizontal mb-5">
                        ...
                        <div class="content">
                            ...
                            <h2 class="heading"><a href="/single">Your most unhappy customers are your greatest
