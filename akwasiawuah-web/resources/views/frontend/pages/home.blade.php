...
@section('content')
    <div class="content-wrapper pad-none">
        <div class="content-inner">
                                    ...
                                    <div class="about-wrap-details">
                                        ...
                                        <div class="text-center">
                                            <div class="about-img bf-pattern mb-5 mb-xl-0">
                                                <img src="{{ asset('frontend_assets/images/about-us/about-1.jpg') }}" class="" alt="about-img">
                                            </div>
                                            <!-- .col -->
                                        </div>
                                    </div>
            ...
            <!-- About Section End -->
            <!-- Get a Quote Section -->
            <section id="get-quote-section" class="get-quote-section section-bg-img" data-bg="{{ asset('frontend_assets/images/bg/bg-1.jpg') }}">
                <div class="container">
                    <!-- Row -->
                                    ...
                                    <div class="ministries-inner">
                                        <div class="ministries-thumb">
                                            <img class="img-fluid squared w-100"
                                                src="{{ asset('frontend_assets/images/ministries/childrens_ministry.jpg') }}" width="360"
                            ...
                            <div class="item">
                                <div class="ministries-box-style-2">
                                    ...
                                    <div class="ministries-inner">
                                        <div class="ministries-thumb">
                                            <img class="img-fluid squared w-100"
                                                src="{{ asset('frontend_assets/images/ministries/women_ministry.jpg') }}" width="360" height="240"
                            ...
                            <div class="item">
                                <div class="ministries-box-style-2">
                                    ...
                                    <div class="ministries-inner">
                                        <div class="ministries-thumb">
                                            <img class="img-fluid squared w-100"
                                                src="{{ asset('frontend_assets/images/ministries/global_ministry.jpg') }}" width="360" height="240"
                                                alt="Agricultural Processing">
                                        </div>
                                        <!-- Ministries Content -->
                                        <div class="ministries-content pad-30">
                            ...
                            <div class="item">
                                <div class="ministries-box-style-2">
                                    ...
                                    <div class="ministries-inner">
                                        <div class="ministries-thumb">
                                            <img class="img-fluid squared w-100"
                                                src="{{ asset('frontend_assets/images/ministries/music_ministry.jpg') }}" width="360" height="240"
                                                alt="Agricultural Processing">
                                        </div>
                                        <!-- Ministries Content -->
                                        <div class="ministries-content pad-30">
            ...
            <section class="contact-form-section typo-white section-bg-img o-visible pad-top-80 pad-bottom-160"
                data-bg="{{ asset('frontend_assets/images/bg/bg-2.jpg') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="owl-carousel blog-main-wrapper blog-style-1" data-loop="1" data-nav="0"
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="blog-inner">
                                            <div class="blog-thumb relative">
                                                <img src="{{ asset('frontend_assets/images/blog/blog-grid/blog-grid1.jpg') }}" class="img-fluid"
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="blog-inner">
                                            <div class="blog-thumb relative">
                                                <img src="{{ asset('frontend_assets/images/blog/blog-grid/blog-grid2.jpg') }}" class="img-fluid"
                                                    width="768" height="600" alt="blog-img" />
                                                <div class="top-meta">
                                                    <ul class="top-meta-list">
                                                        <li>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="blog-inner">
                                            <div class="blog-thumb relative">
                                                <img src="{{ asset('frontend_assets/images/blog/blog-grid/blog-grid3.jpg') }}" class="img-fluid"
                                                    width="768" height="600" alt="blog-img" />
                                                <div class="top-meta">
                                                    <ul class="top-meta-list">
                                                        <li>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="blog-inner">
                                            <div class="blog-thumb relative">
                                                <img src="{{ asset('frontend_assets/images/blog/blog-grid/blog-grid4.jpg') }}" class="img-fluid"
                                                    width="768" height="600" alt="blog-img" />
                                                <div class="top-meta">
                                                    <ul class="top-meta-list">
                                                        <li>
